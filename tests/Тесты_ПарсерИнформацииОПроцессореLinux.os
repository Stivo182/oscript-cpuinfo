...
&Тест
Процедура Arm64БезПолейТопологииВCpuinfo() Экспорт
...
&Тест
Процедура ЛогическиеПроцессорыБезModelName() Экспорт
...
&Тест
Процедура ТопологияИзLscpuДляДвухСокетов() Экспорт
	...
	// Действие
	ПроверяемоеЗначение = ПарсерИнформацииОПроцессореLinux.Распарсить("", Lscpu);
...
&Тест
Процедура ЯдраИзLscpuИспользуютКоличествоПроцессоровИзCpuinfo() Экспорт
...
&Тест
Процедура ТопологияПоPhysicalIdИCoreIdБезCpuCores() Экспорт
	...
	// Действие
	ПроверяемоеЗначение = ПарсерИнформацииОПроцессореLinux.Распарсить(CpuInfo, "Architecture: x86_64");
...
&Тест
Процедура ОдинСокетЕслиИдентификаторСокетаОтсутствует() Экспорт
...
&Тест
Процедура ОдинаковыеCoreIdБезPhysicalIdНаДвухСокетах() Экспорт
...
&Тест
Процедура ОдинСокетПриПустомLscpu() Экспорт
...
&Тест
Процедура ИмяArmИзProcessorБезModelName() Экспорт
	...
	// Действие
	ПроверяемоеЗначение = ПарсерИнформацииОПроцессореLinux.Распарсить(CpuInfo, "Architecture: armv7l");
...
&Тест
Процедура ИмяArmИзHardwareБезModelNameИProcessor() Экспорт
